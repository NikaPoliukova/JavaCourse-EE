...
public interface MessageRepository extends Repository<MessageDto, Long> {
  @Modifying
  @Query("insert into messages (source_user_id, target_user_id, message_content) VALUES (:sourceUserId, :targetUserId, :message_content)")
  ...
  List<Message> getMessagesByFriendId(@Param("sourceUserId")long sourceUserId, @Param("targetUserId") long targetUserId);
